        ...
        <div className={`${styles.blogCard} row`}>
           {dir === "left" &&  <div className={`${styles.media} col-sm-5 `} style={{backgroundImage: `url("https://drive.google.com/uc?export=view&id=${id}")`}}></div>}
            ...
            <div className={styles.content}>
                ...
                <AiOutlineStar style={{marginRight:'10px' , fontSize:'20px'}} />Some Technical knowledge about Project which can be anything like whiich material was used to make it etc etc etc. 
                </p>
